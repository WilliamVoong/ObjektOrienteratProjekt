...
public abstract class AI {
        ...
        for(int i = 0; i < 3; i++) {
            ...
            for(int j = 0; j < 3; j++) {
                ...
                switch(markProperty(currentRowMark, markCount)) {
                    case 0: potentialRowMarkCoordinate = new Coordinate(i, j); break;
                    case 1: rowOffenseCount++; break;
                    case 2: rowDefenseCount++;
                }
                switch(markProperty(currentColumnMark, markCount)) {
                    case 0: potentialColumnMarkCoordinate = new Coordinate(j, i); break;
                    case 1: columnOffenseCount++; break;
                    case 2: columnDefenseCount++;
                }
            }
            ...
            switch(markProperty(currentDiagonal1Mark, markCount)) {
                case 0: potentialDiagonal1MarkCoordinate = new Coordinate(i, i); break;
                case 1: diagonal1OffenseCount++; break;
                case 2: diagonal1DefenseCount++;
            }
            switch(markProperty(currentDiagonal2Mark, markCount)) {
                case 0: potentialDiagonal2MarkCoordinate = new Coordinate(i, 2 - i); break;
                case 1: diagonal2OffenseCount++; break;
                case 2: diagonal2DefenseCount++;
            }
        }
    ...
    private static int markProperty(String mark, int markCount) {
        if(mark.equals("")) {
            return 0;
        } else if(	(mark.equals("X") && markCount % 2 == 0)
                ||
                (mark.equals("O") && markCount % 2 == 1) ) {
            return 1;
        } else {
            return 2;
        }
